...
if(os.name=="nt"): # Check of OS
    PATHCSVFOLDER= ABSPATH+"\\stock\\test" # Windows path
else: PATHCSVFOLDER= ABSPATH+"/stock/test" # Unix path
...
# -------------- DEAP SETUP -------------- Registration object of deap and functions to generate population individuals
random.seed()
...
print(f'Arrivarerà a RIGACSV {MAXTIME-(MAXTIME%4)}')
